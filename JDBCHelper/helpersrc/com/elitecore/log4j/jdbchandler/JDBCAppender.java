...
@since 1.0
*/
public class 	 extends AppenderSkeleton
{
	/**
   ...
   */
	...
	*/
	...
	{
		System.out.println("In APPEND OF JDBCAPPENDER WITH LOGGING EVENT:"+event);
		if(!ready)
      {
      	if(!ready())
         {
   ...
   {
	   System.out.println("IN FLUSH BUFFER");
   	try
      {
        	...
        	for(int i=0; i<size; i++)
         {
				...
				/**
				 * Sending event as an object and not formatting it to string.
				 */
				jlogger.append(event);
         }
	...
	*/
	protected void connect() throws Exception
	{
   	if(connected) return;
		...
		System.out.println("CONNECTIONHANDLER:"+connectionHandler);
